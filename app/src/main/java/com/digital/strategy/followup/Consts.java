...
public class Consts {
    public static final String APP_ID = "29311";
    public static final String AUTH_KEY = "hnytOSUtFMuZJzc";
    public static final String AUTH_SECRET = "gmNqVmUvy73RUCm";
...
//    public static final String AUTH_SECRET = "s4VCJZq4uWNer7H";
    ...
    public static final String USER_LOGIN = "followapp_admin";
    public static final String USER_PASSWORD = "12345678";
    public static final String USER_ID = "6290680";
